...
dp(document).ready(function() {
    ...
    if (dp.fn.sudoSlider) {
        dp("#quote-slider").sudoSlider({
            ...
            prevNext: true,
            responsive: true,
            prevHtml: '<a href="#" class="quote-left-indicator"><i class="fa-arrow-left fa icon-arrow-left"></i></a>',
            nextHtml: '<a href="#" class="quote-right-indicator"><i class="fa-arrow-right fa icon-arrow-right"></i></a>',
            useCSS: true,
            continuous: true,
            effect: "fadeOutIn",
            updateBefore: true
